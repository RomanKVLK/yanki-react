              ...
              <div className={styles.wrapper}>
                <button className={styles.button_white} onClick={onClickClosed}>
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <rect x="3" width="34" height="4" transform="rotate(45 3 0)" fill="#E0BEA2" />
                    <rect
                      y="24.0416"
                      width="34"
                      height="4"
